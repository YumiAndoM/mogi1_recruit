...
$Referer_check_domain = "and-youme.site";
...
$require = array('お名前（漢字）','電話番号','メールアドレス','指導経験','class');
...
このたびは弊社の求人募集にご応募いただきありがとうございました。
改めて面接の日程日などご連絡させていただきます。
